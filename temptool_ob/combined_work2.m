...
function y=equ5(x,z)
syms l;
q1=besselk(0, 29.*((x-0.79*l).^2+(z-0.62*l).^2).^0.5);
q2=besselk(0, 29.*((x-0.79*l).^2+(0.8-z-0.62*l).^2).^0.5);
f1=@(l) (exp(-29.*(x-0.79*l))).*(q1+q2);
fp1=vpaintegral(f1,l,[0 0.65]);

q3=besselk(0, 29*((x+l).^2+(z)^2).^0.5 );
f2=@(l) (exp(-29*(x+l))).*q3;
fp2=vpaintegral(f2,l,[0,0.08]);

y=1170*fp1+0.82*1510*2*fp2;
end