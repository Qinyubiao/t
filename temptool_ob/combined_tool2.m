...
function theta=integ1(a,b)
    ...
    fun4 = @(y,l) 0.18.*(1./((a-0.1*l-1.1).^2+y.^2+(b+l).^2).^0.5+1./((a-0.1*l-1.1).^2+y.^2+(b-l).^2).^0.5);
    q4 = integral2(fun4,-2.5,2.5,0,0.08);

    theta=0.476*(0.87*(q1+q11)-0.72*(q2+q22)-1.2*(q3+q33)+2287*q4);
end